        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                color: function (item, column) {
                    return ["<span class='color'>Warna</span> " + item.get(column.attr)];
                },
                qty: function (item, column) {
                    return ["<span class='qty'>qty </span> " + item.get(column.attr)];
                },
                model: function (item, column) {
                    return ["<span class='model'>Model</span> " + item.get(column.attr)];
                },
            ...
            simpleCart.extend({
                checkout: function (opts) {
                    ...
                    simpleCart.each(function (item, x) {
                        ...
                        data["item_model_" + counter] = item.get("model");
                        data["item_color_" + counter] = item.get("color");
